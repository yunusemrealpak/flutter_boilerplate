...
abstract class $SampleStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, String token});
}
...
class _$_SampleState implements _SampleState {
  const _$_SampleState({this.isLoading = false, this.token = ''});
  ...
  @override
  String toString() {
    return 'SampleState(isLoading: $isLoading, token: $token)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, token);
...
abstract class _SampleState implements SampleState {
  const factory _SampleState({final bool isLoading, final String token}) =
      _$_SampleState;
