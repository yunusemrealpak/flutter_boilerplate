...
@freezed
class SamplePostModel extends BaseEntity<SamplePostModel> with _$SamplePostModel {
  ...
  factory SamplePostModel.fromJson(Map<String, dynamic> data) => _$SamplePostModelFromJson(data);
