...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i15.IDeeplinkRepository>(() => _i16.DeeplinkRepository(
        gh<_i9.NetworkManager<_i10.SampleResponseModel>>()));
    gh.lazySingleton<_i17.ISampleRepository>(() => _i18.SampleRepository(
        gh<_i9.NetworkManager<_i10.SampleResponseModel>>()));
    gh.factory<_i19.SampleCubit>(
        () => _i19.SampleCubit(gh<_i17.ISampleRepository>()));
    gh.factory<_i20.AuthCubit>(
        () => _i20.AuthCubit(gh<_i13.IAuthRepository>()));
