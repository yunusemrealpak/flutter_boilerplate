...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i13.IDeeplinkRepository>(() => _i14.DeeplinkRepository(
        gh<_i9.NetworkManager<_i10.SampleResponseModel>>()));
    gh.lazySingleton<_i15.ISampleRepository>(() => _i16.SampleRepository(
        gh<_i9.NetworkManager<_i10.SampleResponseModel>>()));
    gh.factory<_i17.SampleCubit>(
        () => _i17.SampleCubit(gh<_i15.ISampleRepository>()));
    gh.lazySingleton<_i18.DeeplinkCubit>(() => _i18.DeeplinkCubit(
          gh<_i4.ICacheManager<_i5.Config>>(instanceName: 'config_service'),
          gh<_i13.IDeeplinkRepository>(),
        ));
    return this;
  }
}
