...
import 'package:tuyap/core/network/models/no_result_response.dart';
import 'package:tuyap/core/utility/helper_functions.dart';
    ...
    try {
      ...
      switch (response.statusCode) {
        ...
        case HttpStatus.accepted:
          ...
          final entity = _parseBody<E, R>(response.data,
              model: parserModel, entityKey: entityKey);
